...
function NewGenericButton({
  ...
  const textToShow =
    comingSoon && isHovered ? comingSoonLabel : label;
  ...
  return (
    <Wrapper>
      ...
      >
        ...
        {/* Label wrapper with fixed width based on main label */}
        <span
          style={{
            position: "relative",
            display: "inline-flex",
        ...
        >
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              <Label className="label">{textToShow}</Label>
            </motion.span>
          </AnimatePresence>
        </span>
...
export default NewGenericButton;
